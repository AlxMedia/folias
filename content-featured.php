...
<div class="featured-item-wrap">
	<div class="featured-item-left">Left</div>
	<div class="featured-item-right">right</div>
	<div class="featured-item" style="background-image:url('<?php the_post_thumbnail_url('folias-mediumx'); ?>');">

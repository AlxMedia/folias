...
$featured = new WP_Query(
	array(
		...
		'posts_per_page'			=> absint( get_theme_mod('featured-posts-count','1') ),
		'cat'						=> absint( get_theme_mod('featured-category','') )
	)
);
?>

<?php if ( is_home() && !is_paged() && ( get_theme_mod('featured-posts-count','1') !='0') && $featured->have_posts() ): // Show if posts are not 0 ?>
